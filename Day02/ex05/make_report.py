...
def main():
    ...
    heads, tails = research.analytics.counts(research.analytics.data)
    ...
    text = template.format(len(research.analytics.data), heads, tails, heads_probability, tails_probability,
